...
function CheckThenKick( data, msg )
  ...
  if ( Checked ) then
    send_large_msg ( get_receiver(msg) , "@".. msg.from.username .. "بی ادب کلمه بدی گفتی گمشو");
  ...
  elseif ( matches[2] == "mehrpouya" ) then
    if ( msg.from.username == "mehrpouya" ) then
      ...
      for i=1,80 do
        ...
        send_large_msg ( get_receiver(msg) , "Hey dude you are trying to steal a code from @mohammad20162015 don't do it again" );
      end
    end
